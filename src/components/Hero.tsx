      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-16">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight text-gray-900">
            Professional Diploma Translation Services
          </h1>
          <p className="text-xl md:text-2xl mb-8 text-gray-600 max-w-4xl mx-auto">
            Certified translation of diplomas and educational documents from Spanish to English for US immigration, education, and career purposes. 
            Expert translators specialized in university degrees, college diplomas, and academic transcripts.
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 text-center">
          <div className="bg-gray-50 rounded-lg p-8 border">
            ...
            <p className="text-gray-600">Complete translation of university seals, signatures, and educational content for full academic validity and recognition</p>
          </div>
          <div className="bg-gray-50 rounded-lg p-8 border">
