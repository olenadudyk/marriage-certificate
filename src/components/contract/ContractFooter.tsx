      ...
      <div className="container mx-auto max-w-6xl px-4">
        <div className="mb-8 text-center">
          <p className="text-gray-300 mb-4">
            Horarios de soporte: 7 AM a 4 PM (UTC 0), Lun-Vie.
          </p>
        </div>
        
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            <h4 className="font-semibold mb-4">Traduce.com</h4>
          </div>
          
          <div>
            <h4 className="font-semibold mb-4">Para Clientes</h4>
            <ul className="space-y-2 text-gray-300 text-sm">
              <li><a href="#" className="hover:text-white">Servicios Traduce.com</a></li>
              <li><a href="#" className="hover:text-white">Traducir Documento Online</a></li>
              <li><a href="#" className="hover:text-white">Traducción de Negocios</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300 text-sm">
              <li><a href="#" className="hover:text-white">API Traduce.com</a></li>
              <li><a href="#" className="hover:text-white">Documentación API</a></li>
              <li><a href="#" className="hover:text-white">Integración Zendesk</a></li>
              <li><a href="#" className="hover:text-white">Integración Zapier</a></li>
        ...
        <div className="border-t border-gray-700 pt-6">
          <div className="text-center text-sm text-gray-400">
            Copyright ©2011-2025 Traduce LLC. Todos los derechos reservados.
          </div>
        </div>
      </div>
    </footer>
