  ...
  const pdfExamples = [
    {
      ...
      description: "Acta de nacimiento completa del registro civil español",
      location: "España, América Latina",
      fileSize: "1.2 MB",
      pages: "2 páginas",
      features: [
        "Detalles de identificación personal",
        "Información y firmas de los padres", 
        "Sellos oficiales del registro y fechas",
        "Estampillas de autoridades gubernamentales"
      ]
    },
    {
    ...
    {
      title: "Certificado de Matrimonio Mexicano con Traducción",
      description: "Certificado de matrimonio con traducción certificada",
      location: "México y otros países de habla hispana",
      fileSize: "1.5 MB",
      pages: "2 páginas", 
      features: [
        "Información completa del matrimonio",
    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto max-w-7xl px-4">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Ejemplos de Traducción de Documentos de Inmigración</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Ve ejemplos de documentos de inmigración en español que traducimos para solicitudes de visa de EE.UU. y procedimientos oficiales. 
            Observa la calidad y formato de nuestras traducciones certificadas de documentos de inmigración.
          </p>
        </div>
        ...
        <div className="text-center mt-12">
          <div className="bg-white border rounded-lg p-8 max-w-4xl mx-auto shadow-sm">
            ...
            <p className="text-gray-600 mb-6">
              Nuestras traducciones de documentos de inmigración mantienen el formato legal exacto y la validez 
