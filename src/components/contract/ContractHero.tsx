      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-16">
          ...
          <p className="text-xl md:text-2xl mb-8 text-gray-600 max-w-4xl mx-auto">
            ...
            Expert translators specialized in passport documents, identification pages, and official stamps for legal acceptance.
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 text-center">
          <div className="bg-gray-50 rounded-lg p-8 border">
            ...
            <p className="text-gray-600">Complete translation of passport pages, official seals, and biographical information with certified accuracy for USCIS acceptance and legal validity</p>
          </div>
          <div className="bg-gray-50 rounded-lg p-8 border">
            ...
            <p className="text-gray-600">24-hour delivery for urgent passport translations with certified precision for visa applications and immigration petitions</p>
          </div>
          <div className="bg-gray-50 rounded-lg p-8 border">
            <Award className="mx-auto mb-4 text-blue-600" size={48} />
            <h3 className="text-xl font-semibold mb-3 text-gray-900">Passport Document Experts</h3>
            <p className="text-gray-600">Specialized translators with expertise in passport translations from all Spanish-speaking countries and territories</p>
          </div>
        </div>
      </div>
    </section>
