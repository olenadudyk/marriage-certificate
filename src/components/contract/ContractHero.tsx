      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-16">
          ...
          <p className="text-xl md:text-2xl mb-8 text-gray-600 max-w-4xl mx-auto">
            Certified translation of death certificates from Spanish to English for legal proceedings, estate matters and official purposes in the United States. 
        ...
        <div className="grid md:grid-cols-3 gap-8 text-center">
          <div className="bg-gray-50 rounded-lg p-8 border">
            ...
            <p className="text-gray-600">Complete translation of official seals, registrar signatures and cause of death for full legal validity and court acceptance</p>
          </div>
          <div className="bg-gray-50 rounded-lg p-8 border">
            ...
            <p className="text-gray-600">24-hour delivery for urgent death certificate translations with certified accuracy for legal and estate proceedings</p>
          </div>
          <div className="bg-gray-50 rounded-lg p-8 border">
