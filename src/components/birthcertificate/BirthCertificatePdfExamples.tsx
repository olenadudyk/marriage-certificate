...
const BirthCertificatePdfExamples = () => {
  const pdfExamples = [
    {
      title: "Spanish Birth Certificate - Original Document",
      description: "Full birth certificate from Spanish Civil Registry",
    ...
    {
      title: "Mexican Birth Certificate with Translation",
      ...
      <div className="container mx-auto max-w-7xl px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            See examples of Spanish birth certificates we translate for US immigration and legal proceedings. 
        ...
        <div className="text-center mt-12">
          <div className="bg-white border rounded-lg p-8 max-w-4xl mx-auto shadow-sm">
            ...
            <p className="text-gray-600 mb-6">
              Our birth certificate translations maintain exact formatting and legal validity 
              required by USCIS, courts, and government agencies for immigration and legal proceedings.
            </p>
            <div className="grid md:grid-cols-3 gap-6 text-center">
              ...
              <div>
                ...
                <div className="text-gray-600 text-sm">Translations accepted by USCIS</div>
              </div>
              <div>
...
export default BirthCertificatePdfExamples;
