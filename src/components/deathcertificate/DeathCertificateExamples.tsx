...
const DeathCertificateExamples = () => {
  const examples = [
    {
      ...
      features: [
        ...
        "Death location and date verified"
      ],
      image: "📋"
    },
    {
        ...
        <div className="text-center mt-12">
          <div className="bg-gray-50 border rounded-lg p-8 max-w-4xl mx-auto">
            ...
            <p className="text-gray-600 mb-6">
              ...
              legal requirements and document standards for official proceedings.
            </p>
...
export default DeathCertificateExamples;
